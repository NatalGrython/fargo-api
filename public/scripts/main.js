...
$('#predmet-button').on('click', function(e){
    ...
    $.ajax({
        ...
        if(!data.ok){
            ...
            $('#predmet-button').after('<table><tr><th>'+data.predmet +'</th><th>' + data.balls +'</th></tr></table>')
            $('#change-predmet').after('<table><tr><th>'+data.predmet +'</th><th>' + data.balls +'</th></tr></table>')
        }
    })
})
...
$('#download-button').on('click', function(e){
    ...
    $.ajax({
        ...
        if(!datas.ok){
            ...
            $('#download-button').after('<table><tr><th>'+datas.address +'</th><th>' + datas.token +'</th></tr></table>')
        }
    })
})
...
$('#get-button').on('click', function(e) {
    ...
    $.ajax({
        ...
        if(!data.ok){
            ...
            $('#get-button').after('<table><tr><th>'+ data.address +'</th><th>' + data.balance +'</th></tr></table>')
        }
    })
})
